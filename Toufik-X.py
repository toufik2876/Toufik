...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    TOUFIK = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if TOUFIK == 'A':
        TOUFIK()
    if TOUFIK == 'B':
        os.system('xdg-open https://www.facebook.com/Touf1k')
        return None
    if TOUFIK == 'C':
        os.system('xdg-open https://facebook.com/Touf1k')
        return None
    if TOUFIK == 'D':
        os.system('xdg-open https://github.com/toufik2876/Toufik.git')
        return None
    if TOUFIK == 'E':
        os.system('exit')
        return None
...
\033[1;96m _____  ____  _     _____ _  _  __  ___  _
\033[1;96m/__ __\/  _ \/ \ /\/    // \/ |/ /  \  \//
\033[1;96m/ \  | / \|| | |||  __\| ||   /    \  /
\033[1;96m| |  | \_/|| \_/|| |   | ||   \    /  \ 
\033[1;96m \_/  \____/\____/\_/   \_/\_|\_\  /__/\\
 \033[1;96m
 \033[1;96m


\033[1;96m
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m AUTHOR  \033[1;96m : \033[1;96mToufik IBN 4X
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m FACEBOOK\033[1;96m : \033[1;96mToufik 4X (TOUFIK) 
\033[1;96m[\033[1;96\033[1;96m]\033[1;96m GITHUB  \033[1;96m : \033[1;96mToufik
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :toufik = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :toufik = ' ~> 2009'
        elif uid[:8] in ['10000000']        :toufik = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:toufik = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:toufik = ' 2010'
        elif uid[:6] in ['100001']          :toufik = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :toufik = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :toufik = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :toufik = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :toufik = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :toufik = ' ~> 2015'
        elif uid[:5] in ['10001']           :toufik = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :toufik = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :toufik = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :toufik = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :toufik = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:toufik = ' ~> 2021'
        elif uid[:5] in ['10008']           :toufik = ' ~>2022'
        elif uid[:5] in ['10009']           :toufik = ' ~> 2023'
        else:toufik=''
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sTOUFIK\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
